  ...
  return (
    <div className='fixed w-screen h-screen flex justify-center top-10 bg-black bg-opacity-40'>
      <div className='relative flex flex-col w-[90%] h-[500px] justify-between items-center mt-40 py-2 px-[2%] max-w-[800px] mx-auto bg-white'>
        <div className='absolute top-0 left-0 right-0 h-20 bg-[#63b65b] flex justify-center items-center gap-2 text-white text-lg font-extrabold'>
          <Check />
          <p>Thank you for your inquiry.</p>
        </div>
        <div className='absolute top-20 rotate-180 w-0 h-0 border-l-8 border-r-8 border-b-8 border-transparent border-b-[#63b65b]'></div>
